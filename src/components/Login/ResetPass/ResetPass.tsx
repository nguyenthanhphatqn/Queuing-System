        ...
        <div className="reset-pass">
            <div className='container-left'>
                ...
                <form className='reset-form'>
                    ...
                    <div><img src={eyeflash} alt='' className ='eye-flash-1'></img></div>
                    <div>
                        <label>Nhập lại mật khẩu</label><br />
                        <input className='password-retype' type="password"></input>
                    </div>
                    <div><img src={eyeflash} alt='' className ='eye-flash-2'></img></div>
                    <div>
                        <Link className="text-link8" to="/login">
                        <button className='confirm' onChange={handleSubmit}>Xác nhận</button>
                        </Link>
                    </div>
                </form>
            </div>
