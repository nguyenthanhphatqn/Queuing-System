...
function DetailService({ dataTableRedux, fetchDataChart }: any) {
  ...
  const handleDropdownValueConnect = (e: any) => {
    console.log(e.value);
  };
  ...
  const ServiceProcessPoint = () => {
    return (
      <>
        <span className="ProcessPoint"></span>
  ...
  return (
    <div className="DetailService">
      ...
      <div className="DetailService_title">Quản lý dịch vụ</div>
      <div className="DetailService__container">
        ...
        <div className="DetailService__container__table">
          <div className="ServiceDropdownsSarch">
            <div className="ServiceDropdownsItem1">
              <div className="ServiceDropdownsSarchFirst">
                <div className="ServiceDropdownsSarchFirstName">
                  Trạng thái{" "}
                </div>
              ...
              <div className="ServiceDropdownsSarchFirst">
                <div className="ServiceDropdownsSarchFirstName chooseTime">
                  Chọn thời gian
                </div>
                <div className="ServiceDropdowns_1">
                  <DatePicker
            ...
            <div className="ServiceDropdownsSarchFirst  ServiceDropdownsSarchFirst_input">
              <div className="ServiceDropdownsSarchFirstName choseKey ServiceDropdownsSarchFirstName--detailService">
                Từ khóa
              </div>
          ...
          <div className="DetailService__container__table__detail">
            ...
            {dataServiceTableDetail.map((item: any, index: any) => (
              <div
          ...
          <Link to="/service/detail-service/update-service">
            {" "}
            <div className="ServiceAdd ServiceAdd--update">
          ...
          <Link to="/service">
            {" "}
            <div className="ServiceAdd ServiceAdd--back">
              <div className="ServiceAddIMG">
