    ...
    <div className="chart">
      <div className="chartItemFirst">
        <div className="chartItemFirstTitle">
          <span className="ChartTitle">Bảng thống kê theo tháng</span>
          <span className="ChartTItleDate">Tháng 11/2021</span>
        </div>

        <div className="chartItemDropdown">
          <span className="chartDropdownTitle">Xem theo</span>
          <Dropdown
            options={options}
