...
export default function Equipment() {
        ...
        const handleDropdownValue = (e:any)=>{      
                if(e.value=='Hoạt động'){
                        ...
                        const filterdata = data.filter(item=> item.stateFilter == 'Ngưng hoạt động')
                        setDataEquipment(filterdata)
                }
                else if(e.value=='Ngưng hoạt động') {
                        const filterdata = data.filter(item=> item.stateFilter == 'Ngưng hoạt động')
                        ...
                        const filterdata = data.filter(item=> item.connectFilter == 'Mất kết nối')
                        setDataEquipment(filterdata)
                }    
                else{
...
return (
        <div className="Equipment">
            ...
            <div className="Equipment__container">
             ...
             <Link to="/equipment/addequipment"><div className="ServiceAdd">
