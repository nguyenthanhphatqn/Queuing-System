  ...
  return (
    <div className="UserInfor">
      <div className="userInforRight">
        <span className="userDetailMess">Thông tin cá nhân</span>
        <div className="UserInforDetailandAvatar">
          <div className="UserInforbell">
            <img
              src={show ? iconbellactive : iconbell}
              alt=""
              onClick={() => setShow(!show)}
            />
            {show && (
              <div className="UserInforbellList">
                <div className="UserInforbellTitle">
                  <span>Thông báo</span>
                </div>
                <ul className="UserInforbellUL">
                  <li>
                    <div className="UserInforbell1">
                      Người dùng: Nguyễn Thị Thùy Dung
                    </div>
                    <div className="UserInforbell2">
          ...
          <div className="UserInforDetailAvatarandInfor">
            ...
            <div className="UserInforDetailAvatarInfor">
              <span className="helloUser">Xin Chào</span>
              <span className="UserInforName">Lê Quỳnh Ái Vân</span>
            </div>
          </div>
        </div>
      </div>
      <div className="UserMoreDetail">
        <div className="UserMoreDetailIMGandname">
          ...
          <span className="UserMoreDetailName">Lê Quỳnh Ái Vân</span>
        </div>
        <div className="UserInforDetailItemS">
          {userData.map((user, index) => {
            return (
              <div key={index} className="UserInforDetailItem">
                <span className="UserInforDetailItemName">{user.name}</span>
