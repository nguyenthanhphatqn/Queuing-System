...
import "../AddRoleManagement/addrolemanagement.css";
import { Link } from "react-router-dom";
import BellandUser from "../BellAndUser/BellAndUser";

export default function AddRoleManageMent() {
  const [nameAddRole, setNameAddRole] = useState<string>();
  ...
  return (
    <div className="AddRoleManageMent">
      ...
      <div className="AddService_Title">Danh sách vai trò</div>

      <div className="AddRoleManageMent__container">
        <div className="AddService_Container">
          <div className="AddService_Container__Title">Thông tin vai trò</div>
                ...
                <div className="AddService_Container__Inputs__ServiceCode">
                  ...
                  <div className="AddService_Container__Inputs__ServiceCode__Input">
                    <input
                      type="text"
                      value={nameAddRole}
                      onChange={(e) => setNameAddRole(e.target.value)}
              ...
              <div className="AddService_Container__Inputs__2">
                ...
                <div className="AddService_Container__Inputs__ServiceCode__Input">
                  <textarea
                    ...
                    value={desAddRole}
                    onChange={(e) => setDesAddRole(e.target.value)}
                  ></textarea>
                </div>
              </div>
